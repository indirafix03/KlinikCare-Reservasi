...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
    <h1 class="h2">Edit Jadwal Praktek</h1>
</div>

<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.jadwal-praktek.update', $jadwalPraktek) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                        ...
                        <select class="form-select @error('dokter_id') is-invalid @enderror" 
                            ...
                            @foreach($dokters as $dokter)
                                <option value="{{ $dokter->id }}" 
                                    {{ old('dokter_id', $jadwalPraktek->dokter_id) == $dokter->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('hari') is-invalid @enderror" 
                            ...
                            @foreach($hari as $day)
                                <option value="{{ $day }}" 
                                    {{ old('hari', $jadwalPraktek->hari) == $day ? 'selected' : '' }}>
                                    {{ $day }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="time" 
                               ...
                               id="jam_mulai" 
                               name="jam_mulai" 
                               value="{{ old('jam_mulai', $jadwalPraktek->jam_mulai) }}" 
                               required>
                        @error('jam_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" 
                               ...
                               id="jam_selesai" 
                               name="jam_selesai" 
                               value="{{ old('jam_selesai', $jadwalPraktek->jam_selesai) }}" 
                               required>
                        @error('jam_selesai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('durasi_per_pasien', $jadwalPraktek->durasi_per_pasien) }}" 
                               min="15" 
                               max="120" 
                               required>
